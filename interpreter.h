...
void interpreter::readCommand(const string& command) {
    ...
    if (words[0] == "go") { // If the first word is "go"
        ...
        if(weapons.size() == 0) { // If there are no items in the room
            cout << "There are no items in this room" << endl; // Print a message
            return; // Return
        }

        while (true){
            cout << "Enter the number of the weapon you want to loot" << endl; // Print a message
        ...
        cout << "You are fully rested" << endl; // Print a message
        ...
        if(enemies.size() == 0) { // If there are no enemies in the room
            cout << "There are no enemies in this room" << endl; // Print a message
            return; // Return
        }

        while (true) { // Continue prompting until a valid choice is entered
            cout << "Enter the number of the enemy you want to confront" << endl; // Print a message
        ...
        if(traders.size() == 0) { // If there are no traders in the room
            cout << "There are no traders in this room" << endl; // Print a message
            return; // Return
        }

        while (true) { // Continue prompting until a valid choice is entered
            cout << "Enter the number of the trader you want to talk to" << endl; // Print a message
        ...
        if(weapons.size() == 0) { // If the inventory is empty
            cout << "You have no weapons" << endl; // Print a message
            return; // Return
        }
        cout << "Your weapons are:" << endl; // Print a message
